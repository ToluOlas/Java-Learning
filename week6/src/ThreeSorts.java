...
public class ThreeSorts 
{
	...
	public static ArrayList<Integer> SortA(ArrayList<Integer> a) //Bubble Sort
	{
	...
	public static ArrayList<Integer> SortB(ArrayList<Integer> a) //Radix Sort
	{
		ArrayList<Integer> array = CopyArray(a);
	...
	public static void SortC(ArrayList<Integer> array,int first,int last)//Quick sort
	{
		if (first < last)
		{
